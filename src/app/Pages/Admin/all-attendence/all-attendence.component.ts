          ...
          return new Promise((resolve) => {
              this.employeeService.getAllAttendanceEmployee().subscribe({
                  next: (response: any) => {
                      ...
                      console.log(`\n🔍 Checking attendance for EmployeeID: ${employeeId} on ${today}`);
                      ...
                      const attendanceForEmployeeToday = allAttendance.find((att: any) => {
                        ...
                        console.log({
                            ...
                            attId,
                            currentId,
                            matchDate: attDate === today,
                            matchId: attId === currentId
                        });
                      ...
                      console.log(`✅ Attendance record found:`, attendanceForEmployeeToday);
                  ...
                  error: (err) => {
                      console.error(`❌ Attendance fetch failed for employee ${employeeId}`, err);
                      resolve("Absent");
                  }
              });
          });
